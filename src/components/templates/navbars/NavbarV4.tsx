      ...
      <header className="sticky top-0 z-50 md:relative w-full bg-background border-b md:border-b-0">
        <div className="container mx-auto px-2 md:px-4">
          ...
          <div className="relative flex h-14 md:h-20 items-center justify-between px-1 md:px-6 border-b border-muted/30">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 md:relative md:left-0 md:translate-x-0 flex items-center justify-center z-10">
              <Logo textClassName="text-lg md:text-2xl whitespace-nowrap text-primary" imageClassName="size-8 md:size-12" sizes="(max-width: 768px) 32px, 48px" className="items-end" />
            </div>

            {/* Desktop Search (Center-aligned on desktop, hidden on mobile) */}
            <div className="hidden md:flex flex-1 items-center justify-center max-w-[400px] lg:max-w-[500px] mx-auto z-10">
              <form onSubmit={handleSearch} className="relative w-full group">
                <label htmlFor="navbar-search" className="sr-only">Search products</label>
                <div className="absolute left-2 top-1/2 -translate-y-1/2 flex items-center justify-center h-6 w-6 rounded-full bg-primary/10 group-focus-within:bg-primary/20 transition-colors">
                  <Search className="h-3.5 w-3.5 text-primary/70 transition-colors group-focus-within:text-primary" />
                </div>
                <input
                  id="navbar-search"
                  type="text"
                  ...
                  className="w-full bg-muted/40 border border-border rounded-full py-2.5 pl-10 pr-10 text-xs focus:ring-1 focus:ring-primary/40 focus:border-primary/50 transition-all outline-none"
                />
                <button
                  type="button"
                  ...
                  className={`absolute right-3 top-1/2 -translate-y-1/2 transition-colors ${isListening ? 'text-destructive animate-pulse' : 'text-muted-foreground hover:text-primary'}`}
                >
